...
void display_text()
{
    ...
    if (sorting == 0) // if not sorting display menu
    {
        ...
        bitmap_output(15, 585, "Press x to CHANGE theme color randomly", GLUT_BITMAP_HELVETICA_18);
        bitmap_output(15, 565, "Press r to RANDOMISE", GLUT_BITMAP_HELVETICA_18);
        bitmap_output(15, 545, "Esc to QUIT", GLUT_BITMAP_HELVETICA_18);
        bitmap_output(15, 525, "Selected sort: ", GLUT_BITMAP_HELVETICA_18);
        bitmap_output(80, 525, *(sort_string + sort_count), GLUT_BITMAP_HELVETICA_18);
    }
